...
<h2>ចំណូលប្រាក់ពន្ធ និង អាករគ្រប់ប្រភេទដែលប្រមូលបាន</h2>
<form>
...
$(document).ready(function(e) {
    ...
    $('#submit').click(function() {
		...
		if(val=='monthly'){
			...
			for_ = "/mr_by_quarter/?list=yearlybymonth&y="+y+"&m="+month;	
			}
		
		if($("#li-t").css("display")!='none' && val !='yearlybymonth'){
			if(t=='t1'){
			for_ = "/mr_print_1/"+for_;
			}
			else if(t=='t2'){
			for_ = "/mr_print_2/"+for_;
				}
			}
			
			//alert('<?php echo base_url('admin/monthly_revenues/'); ?>'+for_);
        	window.location = '<?php echo base_url('admin/monthly_revenues/'); ?>'+for_;
