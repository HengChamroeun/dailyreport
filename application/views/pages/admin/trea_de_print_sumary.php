...
<table class='table table-bordered' id="ReportTable">
	...
	$only = "'SHV11','PNH05','PNH14','CHQ06','BMC10','IAP10','PNH02','TKM10','KPC10','SHV10','TAK10','KDL10','SVR10','KRT10'";
    ...
    <?php
		...
		$mr_oo = $this->m_customs->getTDOO($only,$year,$month);
		//var_dump($mr_oo);
		$forward_balance_oo = (!$mr_oo?0:$mr_oo[0]->forward_balance);;
		$rev_in_month_oo = (!$mr_oo?0:$mr_oo[0]->rev_in_month);
		$rev_year_acc_oo = (!$mr_oo?0:$mr_oo[0]->rev_year_acc);
		$trea_de_in_month_oo = (!$mr_oo?0:$mr_oo[0]->trea_de_in_month);
		$trea_de_year_acc_oo = (!$mr_oo?0:$mr_oo[0]->trea_de_year_acc);
		$authorized_expanse_oo = (!$mr_oo?0:$mr_oo[0]->authorized_expanse);
		$balance_oo = (!$mr_oo?0:$mr_oo[0]->balance);
		
	?>
		<tr class="">
			<td><center><?php echo($i+1) ?></center></td>
           <td class="td-office" style="font-size:10px !important;">នាយកដ្ឋាន សាខា. ការិយាល័យផ្សេងៗ</td>
           <td class="td-forward_balance right_align"><span class="disp"><?php echo(num_format($forward_balance_oo)); ?></span></td>
           <td class="td-rev_in_month right_align"><span class="disp"><?php echo(num_format($rev_in_month_oo)); ?></span></td>
           <td class="td-rev_year_acc right_align"><span class="disp"><?php echo(num_format($rev_year_acc_oo)); ?></span></td>
           <td class="td-trea_de_in_month right_align"><span class="disp"><?php echo(num_format($trea_de_in_month_oo)); ?></span></td>
           <td class="td-trea_de_year_acc right_align"><span class="disp"><?php echo(num_format($trea_de_year_acc_oo)); ?></span></td>
           <td class="td-authorized_expanse right_align"><span class="disp"><?php echo(num_format($authorized_expanse_oo)); ?></span></td>
           <td class="td-balance right_align"><span class="disp"><?php echo(num_format($balance_oo)); ?></span></td>
        </tr>
    </tbody>
    <tfoot>
    	<tr>
    		<td colspan='2' class="total" style="font-size:14px"><center>សរុប</center></td>
    		<td class="td-forward_balance right_align"><span class="disp"><?php echo(num_format($count_forward_balance + $forward_balance_oo)); ?></span></td>
           <td class="td-rev_in_month right_align"><span class="disp"><?php echo(num_format($count_rev_in_month + $rev_in_month_oo)); ?></span></td>
           <td class="td-rev_year_acc right_align"><span class="disp"><?php echo(num_format($count_rev_year_acc + $rev_year_acc_oo)); ?></span></td>
           <td class="td-trea_de_in_month right_align"><span class="disp"><?php echo(num_format($count_trea_de_in_month + $trea_de_in_month_oo)); ?></span></td>
           <td class="td-trea_de_year_acc right_align"><span class="disp"><?php echo(num_format($count_trea_de_year_acc + $trea_de_year_acc_oo)); ?></span></td>
           <td class="td-authorized_expanse right_align"><span class="disp"><?php echo(num_format($count_authorized_expanse + $authorized_expanse_oo)); ?></span></td>
           <td class="td-balance right_align"><span class="disp"><?php echo(num_format($count_balance + $balance_oo)); ?></span></td>
    	</tr>
    </tfoot>
</table>
