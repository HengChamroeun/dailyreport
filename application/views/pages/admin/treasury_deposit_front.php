...
<h2>តារាងសរុបលទ្ធផលចំណូលបង់ចូលរតនាគារជាតិនិងសល់បេឡា</h2>
<form>
...
<ul style="list-style:none;" class="opt">
    ...
    <li class="pad-in" style="display:none;">តារាងសំរាប់&nbsp;
    	<select name="select_type" id="select_type">
        	<option value="monthly" selected>ខែ</option>
...
$(document).ready(function(e) {
    ...
    $('#submit').click(function() {
		...
		if(val=='monthly'){
			...
			for_ = "/year_by_month/?list=yearlybymonth&y="+y+"&m="+month;	
			}
		...
		if($("#li-t").css("display")!='none' && val !='yearlybymonth'){
			...
			//alert('<?php echo base_url('admin/treasury_deposit/'); ?>'+for_);
        	window.location = '<?php echo base_url('admin/treasury_deposit/'); ?>'+for_;
