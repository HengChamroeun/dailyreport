...
<table class='table table-bordered' id="ReportTable">
    ...
    <?php
		...
		$mr_oo = $this->m_customs->getMROO($only,$year,$month);
		//var_dump($mr_oo);
		$cd_oo = (!$mr_oo?0:$mr_oo[0]->cd);;
		$st_oo = (!$mr_oo?0:$mr_oo[0]->st);
		$at_oo = (!$mr_oo?0:$mr_oo[0]->at);
		$et_oo = (!$mr_oo?0:$mr_oo[0]->et);
		$other_oo = (!$mr_oo?0:$mr_oo[0]->other);
		$vop_oo = (!$mr_oo?0:$mr_oo[0]->vop);
		$vpp_ea_oo = (!$mr_oo?0:$mr_oo[0]->vpp_ea);
		$vpp_other_oo = (!$mr_oo?0:$mr_oo[0]->vpp_other);
		$vop_io_oo = (!$mr_oo?0:$mr_oo[0]->vop_io);
		$vap_oo = (!$mr_oo?0:$mr_oo[0]->vap);
		$vat_other_oo = (!$mr_oo?0:$mr_oo[0]->vat_other);
		
		$count_oo = $cd_oo + $st_oo + $at_oo + $et_oo + $other_oo + $vop_oo + $vpp_ea_oo + $vpp_other_oo + $vop_io_oo + $vap_oo + $vat_other_oo;
	?>
		<tr class="">
			<td><center><?php echo($i+1) ?></center></td>
           <td class="td-office" style="font-size:8px !important;">នាយកដ្ឋាន សាខា. ការិយាល័យផ្សេងៗ</td>
    		<td class="td-count right_align"><?php echo(num_format($count_oo)); ?></td>
           <td class="td-cd right_align"><span class="disp"><?php echo(num_format($cd_oo)); ?></span></td>
           <td class="td-st right_align"><span class="disp"><?php echo(num_format($st_oo)); ?></span></td>
           <td class="td-at right_align"><span class="disp"><?php echo(num_format($at_oo)); ?></span></td>
           <td class="td-et right_align"><span class="disp"><?php echo(num_format($et_oo)); ?></span></td>
           <td class="td-other right_align"><span class="disp"><?php echo(num_format($other_oo)); ?></span></td>
           <td class="td-vop right_align"><span class="disp"><?php echo(num_format($vop_oo)); ?></span></td>
           <td class="td-vpp-ea right_align"><span class="disp"><?php echo(num_format($vpp_ea_oo)); ?></span></td>
           <td class="td-vpp-other right_align"><span class="disp"><?php echo(num_format($vpp_other_oo)); ?></span></td>
           <td class="td-vop-io right_align"><span class="disp"><?php echo(num_format($vop_io_oo)); ?></span></td>
           <td class="td-vap right_align"><span class="disp"><?php echo(num_format($vap_oo)); ?></span></td>
           <td class="td-vat-other right_align"><span class="disp"><?php echo(num_format($vat_other_oo)); ?></span></td>
        </tr>
    </tbody>
    <tfoot>
    	<tr>
    		<td colspan='2' class="total"><center>សរុប</center></td>
    		<td class="td-count right_align"><?php echo(num_format($count_all + $count_oo)); ?></td>
           <td class="td-cd right_align"><span class="disp"><?php echo(num_format($count_cd + $cd_oo)); ?></span></td>
           <td class="td-st right_align"><span class="disp"><?php echo(num_format($count_st + $st_oo)); ?></span></td>
           <td class="td-at right_align"><span class="disp"><?php echo(num_format($count_at + $at_oo)); ?></span></td>
           <td class="td-et right_align"><span class="disp"><?php echo(num_format($count_et + $et_oo)); ?></span></td>
           <td class="td-other right_align"><span class="disp"><?php echo(num_format($count_other + $other_oo)); ?></span></td>
           <td class="td-vop right_align"><span class="disp"><?php echo(num_format($count_vop + $vop_oo)); ?></span></td>
           <td class="td-vpp-ea right_align"><span class="disp"><?php echo(num_format($count_vpp_ea + $vpp_ea_oo)); ?></span></td>
           <td class="td-vpp-other right_align"><span class="disp"><?php echo(num_format($count_vpp_other + $vpp_other_oo)); ?></span></td>
           <td class="td-vop-io right_align"><span class="disp"><?php echo(num_format($count_vop_io + $vop_io_oo)); ?></span></td>
           <td class="td-vap right_align"><span class="disp"><?php echo(num_format($count_vap + $vap_oo)); ?></span></td>
           <td class="td-vat-other right_align"><span class="disp"><?php echo(num_format($count_vat_other + $vat_other_oo)); ?></span></td>
    	</tr>
    </tfoot>
</table>
