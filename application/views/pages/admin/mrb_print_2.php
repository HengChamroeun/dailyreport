...
<table class='table table-bordered' id="ReportTable">
	...
	//important branches
	//$only = "'SHV11','PNH05','PNH14','CHQ06','PNH02','BMC10','IAP10','TKM10','KPC10','SHV10','KKG10','TAK10','KDL10','SVR10','BAT10','KRT10','RAT01','PVR01','MKR01','CHQ05','KCH10','KSP10','CHQ01','CHQ02','CHQ03','CHQ04','KEB10'";
	...
	?>
    	<tr class="">
           ...
           <td class="td-office">សាខា ខេត្តក្រចេះ</td>
    		<td class="td-count right_align"><?php echo(num_format(0)) ?></td>
           <td class="td-other-rev right_align"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-total-vat right_align"><?php echo(num_format(0)) ?></td>
           <td class="td-vat-gio right_align"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-vat-ngoemb right_align"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-vat-other right_align"><span class="disp"><?php echo(num_format(0)); ?></span></td>
        </tr>
