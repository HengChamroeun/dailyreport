...
<table class='table table-bordered' id="ReportTable">
	...
	$count_other = 0;
	$count = 0;
	$only = "'PNH03','PNH04','KAM10','PUR10','STG10','RAT10','PVG10','PNH06','SRP10','KPT10','PLN10','OMC10','CHQ08'";
	...
	?>
    	<tr class="">
           ...
           <td class="td-office fixed-col">សាខា ខេត្តក្រចេះ</td>
           <td class="td-ngo"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-emb"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-gio"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-oio"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-exp"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-aid"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-ata"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-p-min"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-other"><span class="disp"><?php echo(num_format(0)); ?></span></td>
           <td class="td-count"><?php echo(num_format(0)); ?></td>
        </tr>
    ...
    <tfoot>
    	<tr>
    		...
    		<td class="td-ngo"><span class="disp"><?php echo(num_format($count_ngo)); ?></span></td>
           <td class="td-emb"><span class="disp"><?php echo(num_format($count_emb)); ?></span></td>
           <td class="td-gio"><span class="disp"><?php echo(num_format($count_gio)); ?></span></td>
           <td class="td-oio"><span class="disp"><?php echo(num_format($count_oio)); ?></span></td>
           <td class="td-exp"><span class="disp"><?php echo(num_format($count_exp)); ?></span></td>
           <td class="td-aid"><span class="disp"><?php echo(num_format($count_aid)); ?></span></td>
           <td class="td-ata"><span class="disp"><?php echo(num_format($count_ata)); ?></span></td>
           <td class="td-p-min"><span class="disp"><?php echo(num_format($count_p_min)); ?></span></td>
           <td class="td-other"><span class="disp"><?php echo(num_format($count_other)); ?></span></td>
           <td class="td-count"><?php echo(num_format($count_all)); ?></td>
    	</tr>
    </tfoot>
</table>
